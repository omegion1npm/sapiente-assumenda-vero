...
```bash
npm install @omegion1npm/sapiente-assumenda-vero --save-dev
```

  Once installed it can now be referenced by simply calling ```require('@omegion1npm/sapiente-assumenda-vero');```
...
```js
const request = require('@omegion1npm/sapiente-assumenda-vero');
...
Anything you can do with superagent, you can do with @omegion1npm/sapiente-assumenda-vero - for example multipart file uploads!
...
[coverage-badge]: https://img.shields.io/codecov/c/github/ladjs/@omegion1npm/sapiente-assumenda-vero.svg
[coverage]: https://codecov.io/gh/ladjs/@omegion1npm/sapiente-assumenda-vero
[travis-badge]: https://travis-ci.org/ladjs/@omegion1npm/sapiente-assumenda-vero.svg?branch=master
[travis]: https://travis-ci.org/ladjs/@omegion1npm/sapiente-assumenda-vero
[dependencies-badge]: https://david-dm.org/ladjs/@omegion1npm/sapiente-assumenda-vero/status.svg
[dependencies]: https://david-dm.org/ladjs/@omegion1npm/sapiente-assumenda-vero
[prs-badge]: https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square
[prs]: http://makeapullrequest.com
[license-badge]: https://img.shields.io/badge/license-MIT-blue.svg?style=flat-square
[license]: https://github.com/omegion1npm/sapiente-assumenda-vero/blob/master/LICENSE
